			...
			<div class="row">
				...
				<form action="" method="POST" role="form">
					...
					<div class="phai col-md-4"><br>
						<h3>Giá: <?php echo $value["gia_cs"]; ?>đ</h3><br>
						...
						<input type="hidden" name="id_cs" value="<?php echo $value["id_cs"]; ?>">
						<button type="submit" name="add_to" value="cart" class="btn btn-danger">Thêm vào Giỏ Hàng</button>
						<?php echo $status; ?>
					</div>
				</form>
				<?php } ?>
