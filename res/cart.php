								...
								<td>
									<div class="course-list">
										...
										<div class="course-content col-md-7">
											...
											<p class="author">Giảng viên: <b><?php echo $value['tc_cs']; ?></b></p>
											<h4 class="price"><?php echo $value['gia_cs']; ?>đ</h4>
										</div>
										<div class="course-action col-md-1">
											<a href="cart?delete=<?php echo $value['id_cs']; ?>" class="btn btn-default" onclick="return confirm('Bạn thực sự muốn hủy mua khóa học này?');"><i class="fa fa-times"></i></a>
										</div>
									</div>
								</td>
							</tr>
				...
				<div class="phai col-md-4">
					...
					<table class="table table-hover">
						<thead>
							<tr>
								<th>Tiền của bạn: </th>
								<th><?php echo $_SESSION['coin_user'] ?>đ</th>
							</tr>
							<tr>
								<th>Tổng tiền: </th>
								<th><?php echo $price; ?>đ</th>
							</tr>
							<tr>
								<th>Số tiền còn lại: </th>
								<th><?php echo $_SESSION['tien_thua'] = $_SESSION['coin_user'] - $price; ?>đ</th>
							</tr>
						</thead>
					</table>
					<?php 
