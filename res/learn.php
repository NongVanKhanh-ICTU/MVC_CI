			...
			<div class="row">
				...
				<div class="col-md-8">
					<span class="thumbnail">
						<iframe width="740" height="398" src="https://www.youtube.com/embed/videoseries?list=<?php echo $value['playlist_key'] ?>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
					</span>
					<div class="info-author">
						<p>Giảng Viên: <b>Lê Thẩm Dương</b></p>
					</div>
				</div>
				<?php } ?>
				<div class="col-md-4">
